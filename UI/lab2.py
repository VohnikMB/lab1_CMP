...
from BLL import calcProgramFunctionality
...
class Lab2MainWindow(QMainWindow):
    ...
    def add_functions(self):
        ...
        self.btn_equal.clicked.connect(lambda: calcProgramFunctionality.results(self.label_result, self.label_history))
        self.btn_clear.clicked.connect(lambda: calcProgramFunctionality.clear_function(self.label_history))
        self.btn_del.clicked.connect(lambda: calcProgramFunctionality.del_function(self.label_result))
        self.btn_root.clicked.connect(lambda: calcProgramFunctionality.root_function(self.label_result, self.label_history))
