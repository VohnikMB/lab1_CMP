...
class Lab3MainWindow(QMainWindow):
    ...
    def addFunc(self):
        self.lineEdit.textChanged.connect(
            lambda: ASCII_ART_Func.update_text_browser(self.textBrowser, self.lineEdit, self.symbolcomboBox))
        ...
        self.formatButton.clicked.connect(
            lambda: ASCII_ART_Func.formatFunc(self.textBrowser, self.lineEdit, self.symbolcomboBox))
